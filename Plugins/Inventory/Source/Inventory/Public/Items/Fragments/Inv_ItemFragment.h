...
struct FInv_ItemFragment
{
	...
	FInv_ItemFragment& operator=(const FInv_ItemFragment&) = default; // Copy Operation
...
struct FInv_LabeledNumberFragment : public FInv_InventoryItemFragment
{
	...
	// When manifesting for the first time, this fragment will randomize. However, one equipped (For pickup)
...
// Actually does something when equipping and un equipping
USTRUCT(BlueprintType)
